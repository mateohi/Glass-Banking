...
*/	private Integer signingLevelId = null;
	...
	private java.util.ArrayList<Integer> advertisingGroups;
...
/*  public final Infocorp.Framework.BusinessEntities.Security.SecurityDevice getLoginDevice() { return loginDevice; }
 ...
 /* public final java.util.ArrayList<Infocorp.Framework.BusinessEntities.Authentication.AuthorizedIpAddress> getAuthorizedIpAddresses() { return authorizedIpAddresses; }
	...
	@Deprecated
	public final java.util.ArrayList<Integer> getAdvertisingGroups()
	{
		return advertisingGroups;
	}
	@Deprecated
	public final void setAdvertisingGroups(java.util.ArrayList<Integer> value) { advertisingGroups = value; }
...
/*  public final Infocorp.Framework.BusinessEntities.Common.Language getLanguage() { return language; }
	...
	public final Date getLastLoginDate(){ return lastLoginDate; }
	public final void setLastLoginDate(Date value) { lastLoginDate = value; }

	public final Date getLastPasswordChange() { return lastPasswordChange; }
	public final void setLastPasswordChange(Date value) { lastPasswordChange = value; }

	public final int getLoginPasswordAttempts() { return loginPasswordAttempts; }
	public final void setLoginPasswordAttempts(int value) { loginPasswordAttempts = value; }

	public final String getLastAttemptQuestions() { return lastAttemptQuestions; }
	public final void setLastAttemptQuestions(String value) { lastAttemptQuestions = value; }

	public final short getQuestionAttempts() { return questionAttempts; }
	public final void setQuestionAttempts(short value) { questionAttempts = value; }

	public final String getSecretQuestion(){ return secretQuestion; }
	public final void setSecretQuestion(String value) { secretQuestion = value; }

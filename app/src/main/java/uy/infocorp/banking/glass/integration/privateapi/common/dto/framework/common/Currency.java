...
//	private Map<String, Infocorp.Framework.BusinessEntities.Common.ExtendedPropertyValue> extendedProperties;
    ...
    public final void setCurrencyId(String value) {
        currencyId = value;
    }

    public final String getCurrencyAlpha3Code() {
        return currencyAlpha3Code;
    }

    public final void setCurrencyAlpha3Code(String value) {
        currencyAlpha3Code = value;
    }
    ...
    public final void setCurrencyDescription(String value) {

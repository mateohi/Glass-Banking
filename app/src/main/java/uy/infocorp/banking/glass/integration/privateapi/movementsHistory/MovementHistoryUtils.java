...
public class MovementHistoryUtils {
    ...
    private static final int MOVEMENT_HISTORY_DAYS = Resources.getInteger(R.integer.movement_history_days);
    private static final int MOVEMENT_HISTORY_HOURS = (int) TimeUnit.DAYS.toHours(MOVEMENT_HISTORY_DAYS);
    private static final int MAX_MOVEMENT_LENGTH = Resources.getInteger(R.integer.movement_max_history_length);
    ;

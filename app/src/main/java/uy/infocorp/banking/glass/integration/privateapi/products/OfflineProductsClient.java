...
public class OfflineProductsClient {
    ...
    public static List<Product> getConsolidatedPosition() {
        Product[] productList = HttpUtils.typeFromStringData(OFFLINE_JSON, Product[].class);
